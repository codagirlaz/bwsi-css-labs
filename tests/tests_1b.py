...
def test_addition():
    ...
    assert simple_calculator("add", 5.0, 3.1) == 8.1
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 0.3, 1) == -0.7
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 0.2, 10) == 2
...
def test_division():
    ...
    assert simple_calculator("divide", 5, 0.5) == 10
